...
{{ thisYear }}:  <a href="/resources/eagle-archive/eagle-{{ thisYear }}-spring.pdf">Spring</a> / <a href="/resources/eagle-archive/eagle-{{ thisYear }}-summer.pdf">Summer</a> / <a href="/resources/eagle-archive/eagle-{{ thisYear }}-fall.pdf">Fall (LATEST)</a>
{% for yr in years %}
